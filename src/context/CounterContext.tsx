...
const enum REDUCTER_ACTION_TYPE {
  INCREMENT,
  DECREMENT,
  NEW_INPUT,
}
...
const useCounterContext = (initState: StateType) => {
  ...
  const increment = useCallback(() => dispatch({ type: REDUCTER_ACTION_TYPE.INCREMENT }), []);

  const decrement = useCallback(() => dispatch({ type: REDUCTER_ACTION_TYPE.DECREMENT }), []);
